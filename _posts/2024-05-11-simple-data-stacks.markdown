...
2. Using a simple task execution system instead of Airflow or similar. A cron job might be enough , honestly, but I really like the idea of using Fargate tasks started by CRON like events from EventBridge.
